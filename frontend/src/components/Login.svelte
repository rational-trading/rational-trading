...
<button class="button is-primary" on:click={() => { active = true; }}>
        ...
        <div class="is-flex is-flex-direction-column">
            ...
            <div class="is-flex is-flex-direction-column pt-4" id="login-contents">
                ...
                <div class="is-align-self-flex-end pt-5">
                    <div class="field">
                        <div class="control">
                            <button class="button is-link is-medium"><p class="px-3"><strong>Log in</strong></p></button> 
                        </div>
                    </div>
                </div>
                ...
                <div class="is-align-self-center pt-6">
                    <p class="has-text-dark">Don't have an account? Sign up <a class="link" href="/">here</a>.</p>
                </div>
            </div>
        </div>
    </div>

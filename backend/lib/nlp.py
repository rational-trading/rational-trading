...
def get_sentiment(text: str) -> float:
    ...
    """
    t = TextBlob(text)
    assert isinstance(t.sentiment.polarity, float)
...
def get_subjectivity(text: str) -> float:
    ...
    """
    t = TextBlob(text)
    assert isinstance(t.sentiment.subjectivity, float)
